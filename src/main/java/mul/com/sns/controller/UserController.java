...
public class UserController {
	...
	public String refresh(HttpServletRequest request, HttpServletResponse response) {
		...
		String accessCookie = cookieUtil.getCookieValue(request, "Authorization");
		
		if(accessCookie == null) {
				String refreshCookie = cookieUtil.getCookieValue(request, "RefreshToken");
				if(refreshCookie == null) {
					return "status: Anonymous";
				}
				else {
					int seq = jwtUtil.getUserSeq(refreshCookie);
					String refreshToken = jwtUtil.findRefreshToken(seq);
	...
	*/
	...
	@GetMapping(value="/refresh")
	public UserDto refresh(HttpServletRequest req, HttpServletResponse response) {
		log.info("**** reload page ****");
